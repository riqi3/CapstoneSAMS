...
from api.drugmodel.models import UploadDrugFile
...
def process_pdf(request):
    pdf_path = "cbc.pdf"
    dfs = read_pdf(
        pdf_path, pages="all", encoding="cp1252", pandas_options={"header": True}
    )
...
class PatientView(viewsets.ModelViewSet):
    ...
    def create_patient(request):
        try:
            ...
            return Response(
                {"message": "Failed to create patient.", "error": str(e)},
    ...
    def fetch_patients(request):
        try:
            ...
            return Response(
                {"message": "Failed to fetch patients.", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def update_patient(request):
        try:
            ...
            return Response(
                {"message": "Failed to update patient.", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
...
class MedicineView(viewsets.ModelViewSet):
    ...
    def fetch_medicine_by_id(request, drugID):
        try:
            ...
            return Response(
                {"message": "Failed to fetch medicine.", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
...
class CommentView(viewsets.ModelViewSet):
    ...
    def create_comment(request, accountId, recordNum):
        try:
            ...
            comment = Comment.objects.create(
                content=comment_data["content"], account=account, health_record=record
            )
            return Response(
    ...
    def fetch_comments(request):
        try:
            ...
            return Response(
                {"message": "Failed to fetch comments.", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def update_comment(request, comNum):
        try:
            ...
            return Response(
                {"message": "Failed to update comment", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def delete_comment(request, comNum):
        try:
            ...
            return Response(
                {"message": "Failed to delete comment", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
...
class SymptomsView(viewsets.ModelViewSet):
    ...
    def fetch_symptoms(request):
        try:
            ...
            return Response(
                {"message": "Failed to fetch symptoms", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
...
class PersonalNotesView(viewsets.ModelViewSet):
    ...
    def create_personal_note(request):
        try:
            ...
            return Response(
                {"message": "Note successfully created"}, status=status.HTTP_201_CREATED
            )
        except Exception as e:
            return Response(
                {"message": "Failed to create note"}, status=status.HTTP_400_BAD_REQUEST
            )
    ...
    def update_personal_note(request, noteNum):
        try:
            ...
            return Response(
                {"message": "Failed to update note", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def delete_personal_note(request, noteNum):
        try:
            ...
            return Response(
                {"message": "Failed to delete note", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def fetch_prescription_by_ids(request, accountId, recordNum):
        try:
            ...
            prescription = Prescription.objects.get(
                account=account, health_record=record
            )
            serializer = PrescriptionSerializer(prescription)
            return Response(serializer.data, status=status.HTTP_200_OK)
        except Exception as e:
            return Response(
                {"message": "Failed to fetch prescription", "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
