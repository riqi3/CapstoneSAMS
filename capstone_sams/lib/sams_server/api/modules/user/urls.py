...
urlpatterns = [
    ...
    path('<str:accountID>/patients/', PhysicianPatientViewSet.as_view({'get': 'list'}), name='physician_patients_list'), # API Endpoint for a physician to get the list of assigned patients
