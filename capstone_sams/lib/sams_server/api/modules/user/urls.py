from .views import NursePatientViewSet, PersonalNotesView, ObtainTokenView, LogInView, AccountsView, AccountView, PhysicianPatientViewSet
...
urlpatterns = [
    ...
    path('users/account/<str:accountID>', AccountView.fetch_user_by_id, name="fetch_user_by_id"),
    ...
    path('physician/<str:accountID>/patients/', PhysicianPatientViewSet.as_view({'get': 'list'}), name='physician_patients_list'), # API Endpoint for a physician to get the list of assigned patients
