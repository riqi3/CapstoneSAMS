    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Single', 'Single'), ('Divorced', 'Divorced'), ('Widowed', 'Widowed'), ('Separated', 'Separated'), ('Married', 'Married')])),
                ('birthDate', models.DateField()),
                ('department', models.CharField(choices=[('SED', 'SED'), ('Senior HS', 'Senior HS'), ('Kindergarten', 'Kindergarten'), ('SOL', 'SOL'), ('Junior HS', 'Junior HS'), ('SAS', 'SAS'), ('SAMS', 'SAMS'), ('Nursery', 'Nursery'), ('SOE', 'SOE'), ('SCS', 'SCS'), ('SBM', 'SBM')])),
