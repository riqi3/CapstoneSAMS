# Generated by Django 5.0.1 on 2024-03-03 14:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Widowed', 'Widowed'), ('Divorced', 'Divorced'), ('Married', 'Married'), ('Single', 'Single'), ('Separated', 'Separated')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.patient')),
                ('illnessID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.present_illness')),
            ],
            options={
