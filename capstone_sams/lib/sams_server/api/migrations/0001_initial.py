    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Separated', 'Separated'), ('Divorced', 'Divorced'), ('Married', 'Married'), ('Single', 'Single'), ('Widowed', 'Widowed')])),
        ...
        migrations.CreateModel(
            name='Prescription',
            fields=[
                ('presNum', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
