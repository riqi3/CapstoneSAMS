# Generated by Django 5.0.1 on 2024-04-12 15:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Widowed', 'Widowed'), ('Separated', 'Separated'), ('Single', 'Single'), ('Married', 'Married'), ('Divorced', 'Divorced')])),
                ('birthDate', models.DateField()),
                ('department', models.CharField(choices=[('SOL', 'SOL'), ('SCS', 'SCS'), ('SAS', 'SAS'), ('Kindergarten', 'Kindergarten'), ('SED', 'SED'), ('SAMS', 'SAMS'), ('Nursery', 'Nursery'), ('Junior HS', 'Junior HS'), ('SBM', 'SBM'), ('Senior HS', 'Senior HS'), ('SOE', 'SOE')])),
