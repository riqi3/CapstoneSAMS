# Generated by Django 5.0.1 on 2024-04-17 08:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drugCode', models.CharField(unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Married', 'Married'), ('Single', 'Single'), ('Divorced', 'Divorced'), ('Widowed', 'Widowed'), ('Separated', 'Separated')])),
                ('birthDate', models.DateField()),
                ('department', models.CharField(choices=[('Nursery', 'Nursery'), ('SCS', 'SCS'), ('SED', 'SED'), ('Kindergarten', 'Kindergarten'), ('SAMS', 'SAMS'), ('Junior HS', 'Junior HS'), ('SOE', 'SOE'), ('Senior HS', 'Senior HS'), ('SAS', 'SAS'), ('SOL', 'SOL'), ('SBM', 'SBM')])),
