# Generated by Django 5.0.1 on 2024-04-09 14:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Single', 'Single'), ('Married', 'Married'), ('Separated', 'Separated'), ('Widowed', 'Widowed'), ('Divorced', 'Divorced')])),
                ('birthDate', models.DateField()),
                ('department', models.CharField(choices=[('SAMS', 'SAMS'), ('Kindergarten', 'Kindergarten'), ('SOL', 'SOL'), ('SCS', 'SCS'), ('SOE', 'SOE'), ('Senior High School', 'Senior High School'), ('SED', 'SED'), ('Nursery', 'Nursery'), ('SBM', 'SBM'), ('Junior High School', 'Junior High School'), ('SAS', 'SAS')])),
