# Generated by Django 5.0.1 on 2024-04-17 22:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Separated', 'Separated'), ('Widowed', 'Widowed'), ('Single', 'Single'), ('Divorced', 'Divorced'), ('Married', 'Married')])),
                ('birthDate', models.DateField()),
                ('department', models.CharField(choices=[('SCS', 'SCS'), ('SAMS', 'SAMS'), ('Kindergarten', 'Kindergarten'), ('Junior HS', 'Junior HS'), ('SED', 'SED'), ('SAS', 'SAS'), ('Nursery', 'Nursery'), ('SBM', 'SBM'), ('SOL', 'SOL'), ('Senior HS', 'Senior HS'), ('SOE', 'SOE')])),
