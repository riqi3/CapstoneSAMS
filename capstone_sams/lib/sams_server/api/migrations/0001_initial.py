# Generated by Django 4.2.3 on 2024-01-03 14:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(choices=[('Nursery', 'Nursery'), ('Senior High School', 'Senior High School'), ('Junior High School', 'Junior High School'), ('Law School', 'Law School'), ('Tertiary', 'Tertiary'), ('Kindergarten', 'Kindergarten')])),
                ...
                ('assignedPhysician', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
