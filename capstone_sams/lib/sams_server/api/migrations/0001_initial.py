    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('SBM', 'SBM'), ('Nursery', 'Nursery'), ('Junior HS', 'Junior HS'), ('SCS', 'SCS'), ('SAMS', 'SAMS'), ('Kindergarten', 'Kindergarten'), ('Senior HS', 'Senior HS'), ('SOE', 'SOE'), ('SOL', 'SOL'), ('SED', 'SED'), ('SAS', 'SAS')])),
