    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Married', 'Married'), ('Single', 'Single'), ('Widowed', 'Widowed'), ('Separated', 'Separated'), ('Divorced', 'Divorced')])),
                ('birthDate', models.DateField()),
                ('department', models.CharField(choices=[('Senior HS', 'Senior HS'), ('SAMS', 'SAMS'), ('SOL', 'SOL'), ('Nursery', 'Nursery'), ('Junior HS', 'Junior HS'), ('SOE', 'SOE'), ('SAS', 'SAS'), ('SED', 'SED'), ('SCS', 'SCS'), ('Kindergarten', 'Kindergarten'), ('SBM', 'SBM')])),
