# Generated by Django 5.0.1 on 2024-04-10 08:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientStatus', models.CharField(choices=[('Married', 'Married'), ('Widowed', 'Widowed'), ('Divorced', 'Divorced'), ('Single', 'Single'), ('Separated', 'Separated')])),
                ('birthDate', models.DateField()),
                ('department', models.CharField(choices=[('SOL', 'SOL'), ('Junior HS', 'Junior HS'), ('SCS', 'SCS'), ('SAS', 'SAS'), ('SED', 'SED'), ('SAMS', 'SAMS'), ('Nursery', 'Nursery'), ('SBM', 'SBM'), ('Kindergarten', 'Kindergarten'), ('Senior HS', 'Senior HS'), ('SOE', 'SOE')])),
